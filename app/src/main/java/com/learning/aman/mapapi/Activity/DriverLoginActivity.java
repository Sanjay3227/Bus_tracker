        ...
        mLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!TextUtils.isEmpty(email) && !TextUtils.isEmpty(password)){
                    ...
                    mProgressBar = new ProgressDialog(DriverLoginActivity.this);
                    ...
                    Toast.makeText(DriverLoginActivity.this, "Enter Valid email & password", Toast.LENGTH_SHORT).show();
                }
                ...
                if(task.isSuccessful()){
                    ...
                    task.addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(DriverLoginActivity.this, "Login Failed - " + e, Toast.LENGTH_SHORT).show();
                            e.printStackTrace();
                        }
                    });
